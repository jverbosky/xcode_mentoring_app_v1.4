...
//    var fcmIdValue:String = ""  // plist fcmID value to post to Sinatra app
    ...
    func tokenRefreshNotification(_ notification: Notification) {
        if let refreshedToken = FIRInstanceID.instanceID().token() {
            ...
            PushNotifData(fcmIdValue: refreshedToken).evaluatePlist(self.fcmIdKey, refreshedToken)    // ------> new class reference
            PushNotifData(fcmIdValue: refreshedToken).retrievePlistValues()    // ------> new class reference
        }
